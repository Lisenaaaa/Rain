	...
	factory: function (require) {
		...
		plugin = (() => {
			var e = {
									...
									afterWorkspaceDependencyAddition: async (e, t, r, o) => {
										...
										if (
											!(await (async (e, t) => {
												...
												try {
													return 'definitely-typed' === (null === (r = (await o.getObject(a, { attributesToRetrieve: ['types'] })).types) || void 0 === r ? void 0 : r.ts)
												} catch (e) {
													return !1
												}
											})(r, c))
										...
										const g = `${a.suggestUtils.Modifier.CARET}${y.major}`,
											...
											f = s.miscUtils.mapAndFind(i.workspaces, (e) => {
												var t, a
												const o = null === (t = e.manifest.dependencies.get(r.identHash)) || void 0 === t ? void 0 : t.descriptorHash,
													n = null === (a = e.manifest.devDependencies.get(r.identHash)) || void 0 === a ? void 0 : a.descriptorHash
					...
					469: (e, t, r) => {
						...
						function s(e) {
							...
							return void 0 === r
								? a()
								: {
										get: (e, a, o = { miss: () => Promise.resolve() }) => r.get(e, a, o).catch(() => s({ caches: t }).get(e, a, o)),
					...
					223: (e, t, r) => {
						'use strict'
						r.r(t), r.d(t, { addABTest: () => i, createAnalyticsClient: () => n, deleteABTest: () => c, getABTest: () => d, getABTests: () => l, stopABTest: () => u })
						var s = r(757),
							a = r(858),
							o = r(541)
						const n = (e) => {
					...
					757: (e, t, r) => {
						...
						function s(e, t, r) {
							...
							return { headers: () => (e === u.WithinHeaders ? s : {}), queryParameters: () => (e === u.WithinQueryParameters ? s : {}) }
						}
						function a(e) {
							let t = 0
							const r = () => (
					...
					103: (e, t, r) => {
						'use strict'
						r.r(t), r.d(t, { createRecommendationClient: () => n, getPersonalizationStrategy: () => i, setPersonalizationStrategy: () => c })
						var s = r(757),
							a = r(858),
							o = r(541)
						const n = (e) => {
					...
					790: (e, t, r) => {
						...
						function i(e) {
							const t = (r) =>
								e.request(r).then((s) => {
									if ((void 0 !== e.batch && e.batch(s.hits), !e.shouldStop(s))) return s.cursor ? t({ cursor: s.cursor }) : t({ page: (r.page || 0) + 1 })
								})
							return t({})
						}
						const c = (e) => {
							const t = e.appId,
								...
								o = (0, a.createTransporter)({
									...
									].concat((0, s.shuffle)([{ url: t + '-1.algolianet.com' }, { url: t + '-2.algolianet.com' }, { url: t + '-3.algolianet.com' }])),
									...e,
						...
						const p = (e) => (t, r) => {
								...
								return (0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: '1/keys', data: i }, n), (t, r) =>
							...
							m = (e) => (t, r, s) => {
								...
								return (n.queryParameters['X-Algolia-User-ID'] = t), e.transporter.write({ method: o.N.Post, path: '1/clusters/mapping', data: { cluster: r } }, n)
							},
							h = (e) => (t, r, s) => e.transporter.write({ method: o.N.Post, path: '1/clusters/mapping/batch', data: { users: t, cluster: r } }, s),
							y = (e) => (t, r, a) =>
								(0, s.createWaitablePromise)(
									e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/operation', t), data: { operation: 'copy', destination: r } }, a),
							...
							P = (e) => (t, r) =>
								(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Delete, path: (0, s.encode)('1/keys/%s', t) }, r), (r, a) =>
							...
							v = () => (e) => {
								const t = Buffer.from(e, 'base64')
									.toString('ascii')
									.match(/validUntil=(\d+)/)
								if (null === t) throw { name: 'ValidUntilNotFoundError', message: 'ValidUntil not found in given secured api key.' }
							...
							D = (e) => (t) => {
								...
								return !0 === r && (s.getClusters = !0), e.transporter.read({ method: o.N.Get, path: '1/clusters/mapping/pending' }, s)
							},
							x =
								(e) =>
								(t, r = {}) => {
							...
							T = (e) => (t, r, a) =>
								(0, s.createWaitablePromise)(
									e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/operation', t), data: { operation: 'move', destination: r } }, a),
									(r, s) => x(e)(t, { methods: { waitTask: De } }).waitTask(r.taskID, s)
								),
							k = (e) => (t, r) =>
								(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: '1/indexes/*/batch', data: { requests: t } }, r), (t, r) =>
									Promise.all(Object.keys(t.taskID).map((s) => x(e)(s, { methods: { waitTask: De } }).waitTask(t.taskID[s], r)))
								),
							U = (e) => (t, r) => e.transporter.read({ method: o.N.Post, path: '1/indexes/*/objects', data: { requests: t } }, r),
							C = (e) => (t, r) => {
								const s = t.map((e) => ({ ...e, params: (0, a.serializeQueryParameters)(e.params || {}) }))
								return e.transporter.read({ method: o.N.Post, path: '1/indexes/*/queries', data: { requests: s }, cacheable: !0 }, r)
							},
							E = (e) => (t, r) =>
								Promise.all(
									t.map((t) => {
							...
							M = (e) => (t, r) => {
								...
								return (s.queryParameters['X-Algolia-User-ID'] = t), e.transporter.write({ method: o.N.Delete, path: '1/clusters/mapping' }, s)
							},
							W = (e) => (t, r) =>
								(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/keys/%s/restore', t) }, r), (r, a) =>
									(0, s.createRetryablePromise)((r) =>
										O(e)(t, a).catch((e) => {
											if (404 !== e.status) throw e
											return r()
							...
							F = (e) => (t, r) => e.transporter.read({ method: o.N.Post, path: '1/clusters/mapping/search', data: { query: t } }, r),
							G = (e) => (t, r) => {
								...
								return (0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Put, path: (0, s.encode)('1/keys/%s', t), data: c }, i), (r, o) =>
									(0, s.createRetryablePromise)((r) =>
										O(e)(t, o).then((e) =>
											((e) =>
												Object.keys(a)
							...
							H = (e) => (t, r) =>
								(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/batch', e.indexName), data: { requests: t } }, r), (t, r) =>
									De(e)(t.taskID, r)
								),
							K = (e) => (t) =>
								i({
									...
									request: (r) => e.transporter.read({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/browse', e.indexName), data: r }, t),
								}),
							B = (e) => (t) => {
								...
								return i({
									...
									request: (t) => ve(e)('', { ...r, ...t }).then((e) => ({ ...e, hits: e.hits.map((e) => (delete e._highlightResult, e)) })),
								})
							},
							z = (e) => (t) => {
								const r = { hitsPerPage: 1e3, ...t }
								return i({
									...r,
									shouldStop: (e) => e.hits.length < r.hitsPerPage,
									request: (t) => Ne(e)('', { ...r, ...t }).then((e) => ({ ...e, hits: e.hits.map((e) => (delete e._highlightResult, e)) })),
								})
							},
							V = (e) => (t, r, a) => {
							...
							$ = (e) => (t) =>
								(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/clear', e.indexName) }, t), (t, r) => De(e)(t.taskID, r)),
							L = (e) => (t) => {
								const { forwardToReplicas: r, ...n } = t || {},
									i = (0, a.createMappedRequestOptions)(n)
								return (
									r && (i.queryParameters.forwardToReplicas = 1),
									(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/rules/clear', e.indexName) }, i), (t, r) =>
										De(e)(t.taskID, r)
									)
								)
							},
							Q = (e) => (t) => {
								...
								return (
									r && (i.queryParameters.forwardToReplicas = 1),
									(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/synonyms/clear', e.indexName) }, i), (t, r) =>
										De(e)(t.taskID, r)
									)
								)
							},
							J = (e) => (t, r) =>
								(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/deleteByQuery', e.indexName), data: t }, r), (t, r) =>
									De(e)(t.taskID, r)
								),
							_ = (e) => (t) =>
								(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Delete, path: (0, s.encode)('1/indexes/%s', e.indexName) }, t), (t, r) => De(e)(t.taskID, r)),
							X = (e) => (t, r) =>
								(0, s.createWaitablePromise)(
							...
							Z = (e) => (t, r) => {
								...
								return (
									...
									(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Delete, path: (0, s.encode)('1/indexes/%s/rules/%s', e.indexName, t) }, c), (t, r) =>
										De(e)(t.taskID, r)
									)
								)
							},
							ee = (e) => (t, r) => {
								...
								return (
									n && (c.queryParameters.forwardToReplicas = 1),
									(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Delete, path: (0, s.encode)('1/indexes/%s/synonyms/%s', e.indexName, t) }, c), (t, r) =>
										De(e)(t.taskID, r)
									)
								)
							},
							...
							re = (e) => (t, r) => {
								...
								const i = () =>
									Oe(e)(s || '', { ...o, page: n }).then((e) => {
										for (const [r, s] of Object.entries(e.hits)) if (t(s)) return { object: s, position: parseInt(r, 10), page: n }
										if ((n++, !1 === a || n >= e.nbPages)) throw { name: 'ObjectNotFoundError', message: 'Object not found.' }
										return i()
									})
								return i()
							},
							se = (e) => (t, r) => e.transporter.read({ method: o.N.Get, path: (0, s.encode)('1/indexes/%s/%s', e.indexName, t) }, r),
							ae = () => (e, t) => {
							...
							ne = (e) => (t, r) => e.transporter.read({ method: o.N.Get, path: (0, s.encode)('1/indexes/%s/rules/%s', e.indexName, t) }, r),
							ie = (e) => (t) => e.transporter.read({ method: o.N.Get, path: (0, s.encode)('1/indexes/%s/settings', e.indexName), data: { getVersion: 2 } }, t),
							ce = (e) => (t, r) => e.transporter.read({ method: o.N.Get, path: (0, s.encode)('1/indexes/%s/synonyms/%s', e.indexName, t) }, r),
							de = (e) => (t, r) => e.transporter.read({ method: o.N.Get, path: (0, s.encode)('1/indexes/%s/task/%s', e.indexName, t.toString()) }, r),
							le = (e) => (t, r) =>
								(0, s.createWaitablePromise)(
							...
							pe = (e) => (t, r) => {
								const { safe: a, autoGenerateObjectIDIfNotExist: n, batchSize: i, ...c } = r || {},
									d = (t, r, a, n) =>
										(0, s.createWaitablePromise)(
											e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/operation', t), data: { operation: a, destination: r } }, n),
											(t, r) => De(e)(t.taskID, r)
										),
							...
							fe = (e) => (t, r) => {
								...
								return (
									...
									(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/rules/batch', e.indexName), data: t }, d), (t, r) =>
										De(e)(t.taskID, r)
									)
								)
							},
							...
							Ie = (e) => (t, r) => {
								...
								return (
									...
									(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/synonyms/batch', e.indexName), data: t }, d), (t, r) =>
										De(e)(t.taskID, r)
									)
								)
							},
							Oe = (e) => (t, r) => e.transporter.read({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/query', e.indexName), data: { query: t }, cacheable: !0 }, r),
							je = (e) => (t, r, a) =>
								e.transporter.read({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/facets/%s/query', e.indexName, t), data: { facetQuery: r }, cacheable: !0 }, a),
							ve = (e) => (t, r) => e.transporter.read({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/rules/search', e.indexName), data: { query: t } }, r),
							Ne = (e) => (t, r) => e.transporter.read({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/synonyms/search', e.indexName), data: { query: t } }, r),
							Se = (e) => (t, r) => {
								const { forwardToReplicas: n, ...i } = r || {},
									c = (0, a.createMappedRequestOptions)(i)
								return (
									n && (c.queryParameters.forwardToReplicas = 1),
									(0, s.createWaitablePromise)(e.transporter.write({ method: o.N.Put, path: (0, s.encode)('1/indexes/%s/settings', e.indexName), data: t }, c), (t, r) =>
										De(e)(t.taskID, r)
									)
								)
							},
							De = (e) => (t, r) => (0, s.createRetryablePromise)((s) => de(e)(t, r).then((e) => ('published' !== e.status ? s() : void 0))),
							xe = {
								AddObject: 'addObject',
								Analytics: 'analytics',
								Browser: 'browse',
							...
							Re = { Synonym: 'synonym', OneWaySynonym: 'oneWaySynonym', AltCorrection1: 'altCorrection1', AltCorrection2: 'altCorrection2', Placeholder: 'placeholder' }
					},
					45: (e, t, r) => {
						'use strict'
						function s() {
					...
					858: (e, t, r) => {
						...
						function a(e, t) {
							...
							return (
								...
								{ data: Object.entries(s).length > 0 ? s : void 0, timeout: r.timeout || t, headers: r.headers || {}, queryParameters: r.queryParameters || {}, cacheable: r.cacheable }
							)
						}
						...
						function u(e, t, r, a) {
							...
							const S = (t, s) => {
								...
								const d = { data: u, headers: p, method: m, url: g(c, r.path, j), connectTimeout: s(v, e.timeouts.connect), responseTimeout: s(v, a.timeout) },
									l = (e) => {
									...
									b = {
										...
										onRetry(r) {
											...
											return (
												r.isTimedOut && v++,
												Promise.all([e.logger.info('Retryable failure', O(a)), e.hostsCache.set(c, i(c, r.isTimedOut ? n.Timeouted : n.Down))]).then(() => S(t, s))
											)
										},
										onFail(e) {
											throw (l(e), y(e, I(o)))
							...
							return (function (e, t) {
								return Promise.all(t.map((t) => e.get(t, () => Promise.resolve(i(t))))).then((e) => {
									const r = e.filter((e) => c(e)),
										s = e.filter((e) => d(e)),
										a = [...r, ...s]
									return { getTimeout: (e, t) => (0 === s.length && 0 === e ? 1 : s.length + 3 + e) * t, statelessHosts: a.length > 0 ? a.map((e) => l(e)) : t }
								})
							})(e.hostsCache, t).then((e) => S([...e.statelessHosts].reverse(), e.getTimeout))
						}
						function p(e) {
							const { hostsCache: t, logger: r, requester: s, requestsCache: n, responsesCache: i, timeouts: c, userAgent: d, hosts: p, queryParameters: m, headers: h } = e,
								y = {
									hostsCache: t,
									logger: r,
									requester: s,
									...
									read(e, t) {
										...
										const n = { request: e, mappedRequestOptions: r, transporter: { queryParameters: y.queryParameters, headers: y.headers } }
							...
							return Object.keys(e)
								.map((t) => {
									return (function (e, ...t) {
										...
										'%s=%s',
										t,
										((r = e[t]), '[object Object]' === Object.prototype.toString.call(r) || '[object Array]' === Object.prototype.toString.call(r) ? JSON.stringify(e[t]) : e[t])
									)
									var r
								})
								.join('&')
								...
								methods: {
									...
									initAnalytics: () => (e) =>
										o.createAnalyticsClient({
											...p,
											...e,
											methods: { addABTest: o.addABTest, getABTest: o.getABTest, getABTests: o.getABTests, stopABTest: o.stopABTest, deleteABTest: o.deleteABTest },
										}),
									initRecommendation: () => (e) =>
										i.createRecommendationClient({
											...p,
											...e,
											methods: { getPersonalizationStrategy: i.getPersonalizationStrategy, setPersonalizationStrategy: i.setPersonalizationStrategy },
										}),
								},
							})
						}

...
export default class pronouns extends BotCommand {
    ...
    async exec(message:Message, args:any) {
        ...
        if (pronouns === undefined) {pronounsEmbed.setDescription(`No pronouns were found on https://pronoundb.org/ for ${args.user.tag}`)}
        else {pronounsEmbed.setDescription(pronouns!)}

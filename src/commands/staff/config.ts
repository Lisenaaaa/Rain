...
@ApplyOptions<CommandOptions>({
    ...
    slashOptions: {
        ...
        idHints: ['928065482647535687', '966784342036721704', '967144411697917982'],
        options: [
            {
                name: 'action',
                type: 'STRING',
                        ...
                        components: [
                            {
                                type: 'ACTION_ROW',
                                components: [
                                    { type: 'BUTTON', label: 'Yes', style: 'SUCCESS', customId: 'configRemoveMuteRoleYes' },
                                    { type: 'BUTTON', label: 'No', style: 'DANGER', customId: 'configRemoveMuteRoleNo' },
                                ],
                            },
                        ],
                    })
